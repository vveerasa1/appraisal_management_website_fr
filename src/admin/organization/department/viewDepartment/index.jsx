    ...
    return (
        <>
            <div className='pageTanDiv'>
                ...
                <div className='rvDiv'>
                    <Link to="/admin/organization/department/edit" className='rvDiv-btns' type='button'><i className='fa fa-pencil'></i></Link>
                            ...
                            <div className='row'>
                                ...
                                <div className='col-12 col-md-6 col-lg-4'>
                                    <div className='editform-group'>
                                        ...
                                        <input type='text' className='editform-input' value="-" placeholder='' />
                                        {/* before edit click */}
                                        <div className="ef-actionbtns">
                                            <button className="editform-btn" type='button'><i className='fa fa-pencil'></i></button>
                                        </div>
