        ...
        <>
            <div className='pageTanDiv'>
                <div className='viewPageTopDiv'>
                    ...
                    <div className='rvDiv'>
                        <Link to="/admin/holiday/edit" className='rvDiv-btns' type='button'><i className='fa fa-pencil'></i></Link>
                            ...
                            <div className='row'>
                                <div className='col-12 col-md-6 col-lg-6'>
                                    <div className='editform-group'>
                                        ...
                                        <input type='text' className='editform-input' value="Holiday 1" placeholder='' disabled />
                                    </div>
                                </div>
                                <div className='col-12 col-md-6 col-lg-6'>
                                    <div className='editform-group'>
                                        <label className='editform-label'>Date</label>
                                        <input type='date' className='editform-input' value="20/07/2024" placeholder='' disabled />
                                    </div>
                                </div>
                                <div className='col-12 col-md-6 col-lg-12'>
                                    <div className='editform-group'>
                                        <label className='editform-label'>Description</label>
                                        <textarea cols={30} rows={3} className='editform-input' value="Lorem ipsum sit amit" placeholder='' disabled></textarea>
                                    </div>
                                </div>
