    ...
    return (
        <>
            <div className='breadcrumb-wrapper'>
                <h3 className='page-name'>User Management</h3>
            ...
            <div className='table-lists-container'>
                <div className='table-top-block'>
                    ...
                    <Link to="/admin/user/add" className='theme-btn btn-blue'><i className='fa fa-plus-circle'></i>Add User</Link>
                </div>
                                ...
                                <tr key={row.eid}>
                                    ...
                                    <td>
                                        <div className='table-action-btns'>
                                            <Link to="/admin/user/edit" className='tbtn edit'><i className='fa fa-edit'></i></Link>
